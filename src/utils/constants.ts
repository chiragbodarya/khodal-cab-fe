...
export const CAB_PLANS: CabPlan[] = [
  {
    ...
    description:
      'Direct premium cab service from Surat to Mumbai. Vehicles available: Sedan, Ertiga, Innova, Innova Crysta.',
    photo:
      'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=600&q=80',
    price: 4500,
    highlights: [
      'Professional sanitized cabs',
      'Toll charges included option',
  ...
  },
  {
    ...
    duration: 'One Way / Round Trip',
    description:
      'Direct premium cab service from Mumbai to Surat. Vehicles available: Sedan, Ertiga, Innova, Innova Crysta.',
    photo:
      'https://images.unsplash.com/photo-1494976388531-d10580905c35?auto=format&fit=crop&w=600&q=80',
    price: 4500,
  ...
  },
  {
    ...
    duration: 'One Way / Round Trip',
    description:
      'Premium taxi from Surat to Ahmedabad. Fast, reliable, and comfortable travel option.',
    photo:
  ...
  },
  {
    ...
    duration: 'One Way / Round Trip',
    description:
      'Premium taxi from Ahmedabad to Surat. Enjoy safe and reliable transport with expert drivers.',
    photo:
  ...
  },
  {
    ...
    description:
      'Premium multi-city route covering Ahmedabad, Surat, and Mumbai. Best for business trips or extended families.',
    photo:
      'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=600&q=80',
    price: 9500,
    highlights: [
      'Multi-stop convenience',
      'Luggage friendly vehicles',
      'Customizable duration & stops',
    ],
    inclusions: ['Fuel charges', 'Driver allowances', 'GST'],
  },
];
