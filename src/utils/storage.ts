...
const DEFAULT_VEHICLES: Vehicle[] = [
  {
    ...
    description: "Premium class sleeper bus with individual berths, semi-sleeper seats, and advanced suspension for a smooth overnight journey.",
    ratePerKm: 45,
    status: "active"
  },
  {
    ...
    description: "Ultra-comfortable tour coach designed for long-distance group tours, offering ample legroom and panoramic windows.",
    ratePerKm: 55,
    status: "active"
  },
  {
    ...
    description: "Perfect for family tours or corporate outings, featuring ergonomic reclining leather seats and premium sound system.",
    ratePerKm: 25,
    status: "active"
  }
];
...
const DEFAULT_PLANS: TravelPlan[] = [
  {
    ...
    description: "Experience the rich heritage of India. Visit the historical monuments of Delhi, the wonder of Taj Mahal in Agra, and the royal palaces of Jaipur.",
    highlights: ["Taj Mahal Sunrise Tour", "Jaipur Amber Fort Elephant/Jeep Ride", "Qutub Minar visit", "Royal Chokhi Dhani Dinner"],
  ...
  },
  {
    ...
    description: "Unwind amidst the green tea plantations of Munnar, explore the wildlife of Thekkady, and cruise along the pristine backwaters in a traditional houseboat.",
    highlights: ["Munnar Tea Estate Walk", "Spice Plantation Tour", "Houseboat Overnight Cruise", "Kathakali Cultural Show"],
    inclusions: ["Luxury Coach Transfer", "Houseboat Stay with All Meals", "Resort Stay", "Local Sightseeing"]
  },
  {
    id: "p3",
    ...
    description: "Escape the summer heat and head into the snow-capped peak valleys of Manali. Indulge in adventure sports at Solang and experience the hippie culture of Kasol.",
    highlights: ["Solang Valley Paragliding", "Rohtang Pass Snow Trek", "Manikaran Sahib Hot Springs", "Riverside Camping"],
    inclusions: ["Volvo Sleeper Travel", "Camp Stay & Hotel Stay", "Bonfire Night", "Breakfast & Dinner"]
  }
];
...
const DEFAULT_BLOGS: Blog[] = [
  {
    ...
    excerpt: "Discover how high-tech sleeper coaches, onboard Wi-Fi, and plush interiors are changing the way people travel across the country.",
...
Plan your next holiday with us and experience travel like never before!`,
  ...
  },
  {
    ...
    excerpt: "Beyond Jaipur and Udaipur, Rajasthan holds secret forts, blue stepwells, and desert sanctuaries. Here are the top 5 hidden places.",
...
const DEFAULT_INQUIRIES: Inquiry[] = [
  {
    ...
    date: "2026-06-22",
    message: "We are a family of 4 looking to book this package for next month. Are there any discounts available for children?",
    status: "pending"
  }
];
