  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        ...
        {...field}
        {...props}
        className={`w-full resize-none rounded-lg border bg-zinc-900 px-3.5 py-2.5 text-sm text-white placeholder-zinc-500 transition-all duration-200 outline-none ${
          hasError
